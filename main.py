...
for _asset in ("admin.css", "admin.js", "list.js", "detail.js", "screen.js", "document-check.js",
               "generate-link.js", "kyb.js", "databases.js", "users.js", "user-detail.js", "firms.js",
               "firm-detail.js", "api.js", "idntory-logo.png", "favicon.png"):
    _f = _HERE / _asset
    if _f.exists():
...
for _page in ("login", "list", "detail", "screen", "document-check", "generate-link", "kyb", "databases", "api", "users", "user-detail", "firms", "firm-detail"):
